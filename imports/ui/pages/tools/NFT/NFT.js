    ...
    const newTokenHolderHtml = `
      <div class="token-holder-entry rounded-lg border border-base-300/80 bg-base-100/60 p-3">
        <fieldset class="fieldset w-full">
          <legend class="fieldset-legend">Owner Address</legend>
        ...
        <fieldset class="fieldset w-full">
          <legend class="fieldset-legend">Owner Balance</legend>
          <input type="text" id="initialBalancesAddressAmount_${countRecipientsForValidation}" name="initialBalancesAddressAmount[]" placeholder="Token Balance" value="1" autocomplete="off" class="input input-bordered w-full bg-base-100">
        </fieldset>
